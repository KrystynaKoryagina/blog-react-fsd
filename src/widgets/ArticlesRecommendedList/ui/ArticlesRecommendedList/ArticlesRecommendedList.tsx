...
export const ArticlesRecommendedList = memo(({ className }: ArticlesRecommendedListProps) => {
  const { t } = useTranslation('article');

  const { data: articles, isLoading, isError } = useGetRecommendedArticlesQuery(4);
